...
struct NewTaskView: View {
    ...
    var items = [
        ...
        Color(red: 252 / 255, green: 95 / 255, blue: 136 / 255)
    ...
    var body: some View {
        ...
        ZStack {
            ...
            Color(red: 252 / 255, green: 95 / 255, blue: 136 / 255).edgesIgnoringSafeArea(.all)
            ...
            VStack(alignment: .leading) {
                ...
                Button (action: {
                    ...
                    Text("Create Goal")
                        ...
                        .background(Color(red: 252 / 255, green: 95 / 255, blue: 136 / 255))
